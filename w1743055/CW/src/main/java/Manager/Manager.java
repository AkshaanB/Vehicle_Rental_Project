...
public class Manager {
    ...
    public static void main(String[] args) {
        ...
        MongoCollection<Document> collectionVehicles = database.getCollection("Vehicles");
        MongoCollection<Document> collection1 = database.getCollection("Cars");  //creates the collection
        MongoCollection<Document> collection2 = database.getCollection("Motorbikes");
